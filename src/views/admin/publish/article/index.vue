  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.status" placeholder="按条件查找" clearable class="filter-item" style="width: 130px">
        ...
        <el-option value="published" label="已上架"/>
      </el-select>
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="330" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          ...
          <el-button v-if="row.status =='wait'" size="mini" type="success"
          @click="toReviewed(row)" >
            审核
          </el-button>
           <el-button v-if="row.status =='published'" size="mini" type="danger"
          @click="xiajia(row)" >
            下架
          </el-button>
          ...
          <el-button v-if="row.status=='wait'" size="mini" type="danger"
          @click="toDraft(row)" >
            打回
          </el-button>
        </template>
...
<script>
import { getArticleList,updateArticle} from '@/api/admin/admin'
