    ...
    >
      ...
      <el-table-column class-name="status-col" label="状态" width="110" align="center">
        ...
        <template slot-scope="{row}">
          ...
          <el-button v-if="row.videoStatus =='wait'" size="mini" type="success"
          @click="toReviewed(row)" >
            审核
          </el-button>
           <el-button v-if="row.videoStatus =='published'" size="mini" type="danger"
          @click="xiajia(row)" >
            下架
          </el-button>
          <el-button v-if="row.videoStatus =='reviewed'" size="mini" type="success"
          @click="toPublished(row)" >
            上架
          </el-button>
          <el-button v-if="row.videoStatus =='wait'" size="mini" type="danger"
          @click="toDraft(row)" >
            打回
          </el-button>
        </template>
...
<script>
import { getVideoList,updateVideo} from '@/api/admin/admin'
